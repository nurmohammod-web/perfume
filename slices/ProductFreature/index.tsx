...
/**
 * Props for `ProductFreature`.
 */
export type ProductFreatureProps =
  SliceComponentProps<Content.ProductFreatureSlice>;

/**
 * Component for "ProductFreature" Slices.
 */
const ProductFreature: FC<ProductFreatureProps> = async ({ slice }) => {
  const client = createClient();
  const fragrance = isFilled.contentRelationship(slice.primary.fragance)
    ? await client.getByID<Content.FragranceDocument>(slice.primary.fragance.id)
    : null;
...
export default ProductFreature;
