        ...
        >
          {slice.primary.button.map((link) => (
            <PrismicNextLink
              ...
              field={link}
              className={
                "inline-flex items-center justify-center border border-white px-12 py-4 text-center font-extrabold tracking-wider text-white uppercase transition-colors duration-300 hover:bg-white/20"
              }
            />
          ))}
        </FadeIn>
